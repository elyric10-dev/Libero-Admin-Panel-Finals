...
<div class="pop_up_container">
    <div class="close_main_popup_container"><a href="<?php if($email === 'admin'){
        echo 'http://localhost/Libero_V3.0_WITH_BACKEND/php/admin_dashboard.php';
        header('Location: http://localhost/Libero_V3.0_WITH_BACKEND/php/admin_dashboard.php');
    }else{
        echo 'http://localhost/Libero_V3.0_WITH_BACKEND/php/logout.php';
    }?>"><b>X</b></a></div>
        <div class="pop_up_items">
            ...
            <div class="map_details_container">
                <div class="text"><?php echo "Email: <br><b class='fonts'>".$user_email."</b class='fonts'><br>Phone: <b class='fonts'>".$phone."</b><br>Postcode: <b class='fonts'>".$postcode."</b>";
                    echo "<h3>";
