...
if(isset($_POST['signup_button'])){
    ...
    if(mysqli_num_rows($get_email)>0){
        ...
        $details = "INSERT INTO `details`(`fullname`,`postcode`,`selection`,`phone`) VALUES('$fullname',$postcode,'$selection','$phone')";
    ...
    if(isset($_POST['login_button'])){
        ...
        $login_user = "SELECT * FROM users WHERE BINARY email = '$email' AND password = '$password'";
        ...
        if(mysqli_num_rows($login_user_query)>0){
            ...
            $get_credentials_id = mysqli_fetch_assoc($login_user_query);
            
            $email_id = $get_credentials_id['id'];
            $_SESSION['email'] = $get_credentials_id['email'];
            echo $email_id;


            $get_data = "SELECT * FROM details WHERE id = $email_id LIMIT 1";
            ...
            $_SESSION['selection'] = $get_all_data['selection'];
            $_SESSION['phone'] = $get_all_data['phone'];
                            ...
                            <form action="" method="POST" class="register_form">
                                ...
                                <div class="email_phone_container">
                                    ...
                                    <div class="phone">
                                        ...
                                        <input type="text" name="fullname" id="email" value="<?php echo $fullname; ?>" required>
                                    </div>
                                    <div class="phone">
                                        <div class="ep_label">
                                            Phone number:
